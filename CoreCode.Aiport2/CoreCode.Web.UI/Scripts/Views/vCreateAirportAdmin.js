                    ...
                    var regEmail = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
                        if (!regEmail.test(document.querySelector('#txtEmail').value)) {
                            ...
                            if (age < 18) {
                                ...
                                airportAdminData.Password = instance.GenerateRandomPassword();

                                instance.ctrlActions.PostToAPI('postAirportManager', airportAdminData, function () {
...
$(document).ready(function () {
    ...
    var vairportadmin = new vCreateAirportAdmin();
