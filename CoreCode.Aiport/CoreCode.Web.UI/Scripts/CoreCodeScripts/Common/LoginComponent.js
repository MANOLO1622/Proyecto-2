                        ...
                        if (user != undefined) {
                            ...
                            case 2: //AirportUser
                                ...
                                case 4: //User
                                    ...
                                    break;
                                case 5: //Employee
                                    var employeeIdObject = "id=" + userObjectElement.ID;

                                    instance.ctrlActions.GetFromAPI("getEmployeeById", employeeIdObject, function (response) {
                                        if (response) {
                                            sessionStorage.setItem("employeeObject", JSON.stringify(response.Data));
                                        }
                                        //Redirect to dashboard
