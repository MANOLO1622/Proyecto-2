$(document).ready(function () {
    ...
    $.get("http://localhost:54982/api/getAirlines/", function (data) {
    ...
    $('#airlineManager').DataTable({
        ...
        processing: true,
        "ajax": {
            "url": 'http://localhost:54982/api/getAirlineManagers',
            "type": "get",
            "datatype": "json",
            dataSrc: "Data"
        },
    ...
    $('#btnAddAirlineManager').click(function () {
        ...
        if (error) {
            ...
            $.post("http://localhost:54982/api/postAirlineManager/", data, function (res) {
                console.log(res);
                swal({
    ...
    $('#airlineManager').on('click', '#btnDelete', function () {
        ...
        swal({
            ...
            if (willDelete) {
                $.delete("http://localhost:54982/api/deleteAirlineManager/", manager, function (res) {
                    swal({
    ...
    $('#airlineManager').on('click', '#btnEdit', function () {
        ...
        $('#btnEditAirlineManager').click(function () {
            ...
            if (error) {
                ...
                $.post("http://localhost:54982/api/updateAirlineManager/", manager, function () {
                    swal({
